...
public class LiquidStack {
    ...
    public static final BuilderCodec<LiquidStack> CODEC;
    ...
    public boolean isEquivalentType(LiquidStack other) {
        if (other == null) {
            return false;
        } else return this.liquidId.equals(other.liquidId);
    }
    ...
    static {
        ...
        CODEC = BuilderCodec.builder(LiquidStack.class, LiquidStack::new)
