...
public class LiquidCapsuleTypes implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, LiquidCapsuleTypes>> {
    ...
    public static void registerLiquidCapsuleType() {
        Collection<LiquidCapsuleTypes> capsuleTypeData = FluxAssetRegistry.CAPSULE_TYPE_ASSET_STORE.getAssetMap().getAssetMap().values();
        for (LiquidCapsuleTypes capsuleType : capsuleTypeData) {
    ...
    public static class Data {
        public static final Codec<Data> CODEC = BuilderCodec.builder(Data.class, Data::new)
                ...
                .documentation("The Hytale ItemID to register (e.g., 'Container_Bucket' or '*Container_Bucket_State_Filled_Water').").add()
                .append(new KeyedCodec<>("LiquidId", Codec.STRING), (o, v) -> o.liquidId = v, o -> o.liquidId)
                .documentation("The LiquidId of the liquid this item contains. Use 'Empty' for empty containers.").add()
                .build();
